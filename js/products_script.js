...
const addModalProductForm = document.querySelector(
  ".modal-body .addProductForm"
);

// edit modal product
const editModalProduct = document.querySelector(".edit_modal_product");
const editModalProductForm = document.querySelector(
  ".modal-body .editProductForm"
);
...
function editProduct(
  ...
  // submitUpdate(id)
  const btn_modal_edit_product = document.getElementById(
    "btnSubmitEditProduct"
  );
...
//     console.log("name product la" + nameProduct);
